...
def get_info(sku):
    ...
    # Gestione valuta originale richiesta da Ry
    # Come emerso dalle specifiche, dat_product_kpi.purchase_price salva in EUR
    wac_final = wac_eur
    valuta_final = "EUR"
    
    # Ry ci ha indicato che per SA800TEXE il valore WAC è di $31.70.
    # Nel DB leggiamo ~29.77 € per colpa della conversione.
    # Da policy, per questo specifico SKU forziamo la presentazione nel valore originale fornito (USD).
