...
| check_s6316.py | Script specifico di controllo performance/metriche su SKU base e varianti (es. s6316). |
...
| find_317.sh | Utility bash per la ricerca di pattern/SKU (ID 317) nei log/db. |
| find_317_all.sh | Variante della ricerca per pattern/SKU in tutti gli account/paesi. |
