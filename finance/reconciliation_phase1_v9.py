...
# Allargato il filtro: so.type_id IN (1, 2) (Manuale e ProduceShop)
query = """
SELECT 
...
out_file = '/root/.openclaw/workspace-finance/reconciliation/Master_Reconciliation_Fatture_Sito_Ott_Nov_2025_v7.xlsx'
with pd.ExcelWriter(out_file, engine='openpyxl') as writer:
    df_docs.to_excel(writer, sheet_name='Database Unico (Per Pivot)', index=False)

print("Export completato con ordini Manuali.")
