...
f = '/root/.openclaw/workspace-finance/reconciliation/Master_Reconciliation_Fatture_Sito_Ott_Nov_2025_v7.xlsx'
df_docs = pd.read_excel(f)

file_paypal = '/root/.openclaw/media/inbound/202510_-_Paypal---8ac13786-531e-4b89-aafe-a95aa5dd9290.csv'
df_ppal = pd.read_csv(file_paypal)
...
print("Connessione a Kanguro per incrociare gli ordini PayPal tramite Email e Importo...")
...
# 1st pass: Match on Email + Exact Amount
...
print(f"Match PayPal completato: {matched_count} transazioni incrociate (solo su Ottobre) su {len(df_ppal_pay)}.")
...
out_file = '/root/.openclaw/workspace-finance/reconciliation/Master_Reconciliation_Fatture_Sito_Ott_Nov_2025_v8_PayPal.xlsx'
