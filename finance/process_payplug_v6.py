...
# Convert float diffs to standard format
out_path = '/root/.openclaw/workspace-finance/Associazione_PayPlug_Kanguro_V6.csv'
res_df.to_csv(out_path, index=False, sep=';', encoding='utf-8', float_format='%.2f')
print("Done V6")
