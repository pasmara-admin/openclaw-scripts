...
# Fix: We use b.total and NOT the sum of bil_document_row, to mirror Report_Revenue perfectly.
# Fix: We explicitly exclude cancelled/storned invoices if necessary (state_id = '00')
query = """
SELECT 
...
# Fix transcodifiche in Metodo Pagamento v2 x altri
df_docs['Metodo Pagamento v2'] = df_docs['Metodo Pagamento v2'].replace({
    'Apple Pay': 'Payplug',
...
out_file = '/root/.openclaw/workspace-finance/reconciliation/Master_Reconciliation_Fatture_Sito_Ott_Nov_2025_v4.xlsx'
